...
!--------------------------------------------------------------------------
  ...
  type(sysid_out_t), pointer :: sysid_out(:)
...
!================================================================================
  ...
  subroutine atm_init_mct( EClock, cdata_a, x2a_a, a2x_a, NLFilename )
    ...
    integer :: c,i,ncol ! needed by Ben for looping
    !-----------------------------------------------------------------------
    !
...
!       call cam_run2( cam_out, cam_in )
       call cam_run2( cam_out, cam_in,sysid_out )
