function [H,H_c,C,F,lF,xF, he, he_c] = tranFval_forpaper(x,y,cntrl,nfft,Fsamp,Fmax,flag,fignum,makeplots )
...
if makeplots
    ...
    [ghat,gerr,H,C,F,he,hep,hmag,hph] = gest2_forpaper(x,y,nfft,Fsamp,Fmax,flag,figinfo);
    figinfo.colour = 'r';
    [ghat_c,gerr_c,H_c,C_c,F_c,he_c,hep_c,hmag_c,hph_c] = gest2_forpaper(x,cntrl,nfft,Fsamp,Fmax,flag,figinfo);
